const { insertServices, listServices, dropdownServices, updateServices, deleteServices } = require('../services/role.services');
...
module.exports = { insertHelper, viewHelper, dropDownHelper, updateHelper, deleteHelper };